...
cfg.MODEL.WEIGHTS = "/home/lsquarzoni/work/RetinaNet/OpenImagesV6/output100'000iter_RetinaNet_mnv2/model_final.pth" # path to the model we just trained
...
evaluator = COCOEvaluator("bottle_tin_can_val", output_dir=cfg.OUTPUT_DIR)
